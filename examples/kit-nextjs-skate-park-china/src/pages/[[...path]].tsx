...
export const getStaticPaths: GetStaticPaths = async (context) => {
  ...
  console.log('Bootstrap initializing CloudSDK for pagew:', scConfig.api.edge.clientContextId);

  if (process.env.NODE_ENV !== 'development' && scConfig.generateStaticPaths) {
    console.log('context?.locales:', context?.locales);
    console.log(
      'Fetching static paths for sites:',
    ...
    try {
      ...
      //   context?.locales || []
      // );
      console.log('Fetched static paths:', paths[0]);
      ...
      console.log('Cleaned static paths:', cleanedPaths[0]);
    } catch (error) {
